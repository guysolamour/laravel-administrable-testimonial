...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{-- <h1>{{ Lang::get('administrable-testimonial::translations.label') }}</h1> --}}
                </div>
                <div class="col-sm-6">
            ...
            <div class="card-header">
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip"
                        title="{{ Lang::get('administrable-testimonial::translations.minus') }}">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="btn-group float-right">
                                            ...
                                            <a href="#" class="btn btn-danger d-none" data-model="{{ config('administrable-testimonial.models.testimonial') }}"
                                                id="delete-all"> <i class="fa fa-trash"></i> {{ Lang::get('administrable-testimonial::translations.default.deleteall') }}</a>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ back_route('extensions.testimonial.testimonial.show', $testimonial) }}"
                                                                    ...
                                                                    data-placement="top" title="{{ Lang::get('administrable-testimonial::translations.default.show') }}"><i
                                                                        class="fas fa-eye"></i></a>

                                                                     <a href="{{ back_route('model.clone', get_clone_model_params($testimonial)) }}"
                                                                class="btn btn-secondary" data-toggle="tooltip"
                                                                data-placement="top" title="{{ Lang::get('administrable-testimonial::translations.default.clone') }}"><i
                                                                    class="fas fa-clone"></i></a>

                                                                <a href="{{ back_route('extensions.testimonial.testimonial.edit', $testimonial) }}"
                                                                    class="btn btn-info" data-toggle="tooltip"
                                                                    data-placement="top" title="{{ Lang::get('administrable-testimonial::translations.default.edit') }}"><i
                                                                ...
                                                                <a href="{{ back_route('extensions.testimonial.testimonial.destroy', $testimonial) }}"
                                                                    ...
                                                                    data-placement="top" title="{{ Lang::get('administrable-testimonial::translations.default.delete') }}"><i
