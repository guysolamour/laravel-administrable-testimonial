...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{-- <h1>{{ Lang::get('administrable-testimonial::translations.default.add') }}</h1> --}}
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">{{ Lang::get('administrable-testimonial::translations.default.add') }}</h3>
            ...
            <div class="card-body">
                <div class='row'>
                    <div class='col-md-8'>
                        @include('administrable-livenews::' . Str::lower(config('administrable.back_namespace')) . '.testimonials._form')
                    </div>
                    <div class='col-md-4'>
                        @imagemanagerfront([
                            'model'             =>  $form->getModel(),
