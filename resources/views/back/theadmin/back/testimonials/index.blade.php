                ...
                <div class="card-header">
                    ...
                    <div class="btn-group">
                        <a href="{{ back_route('extensions.testimonial.testimonial.create') }}" class="btn btn-sm btn-label btn-round btn-primary"><label><i
                                    class="ti-plus"></i></label> {{ Lang::get('administrable-testimonial::translations.default.add') }}</a>
                        <a href="#" class="btn btn-sm btn-label btn-round btn-danger d-none" data-model="{{ config('administrable-testimonial.models.testimonial') }}"
                            id="delete-all"><label><i class="fa fa-trash"></i></label> {{ Lang::get('administrable-testimonial::translations.default.deleteall') }}</a>
                            ...
                            <td>
                                <nav class="nav no-gutters gap-2 fs-16">
                                    <a class="nav-link hover-primary" href="{{ back_route('extensions.testimonial.testimonial.show', $testimonial) }}" data-provide="tooltip"
                                        title="{{ Lang::get('administrable-testimonial::translations.default.show') }}"><i class="ti-eye"></i></a>
                                    <a class="nav-link hover-primary" href="{{ back_route('model.clone', get_clone_model_params($testimonial)) }}" data-provide="tooltip"
                                        title="{{ Lang::get('administrable-testimonial::translations.default.clone') }}"><i class="ti-layers"></i></a>
                                    <a class="nav-link hover-primary" href="{{ back_route('extensions.testimonial.testimonial.edit', $testimonial) }}" data-provide="tooltip"
                                        title="{{ Lang::get('administrable-testimonial::translations.default.edit') }}"><i class="ti-pencil"></i></a>
                                    <a class="nav-link hover-danger" href="{{ back_route('extensions.testimonial.testimonial.destroy', $testimonial) }}" data-provide="tooltip" title="Supprimer"
                                        ...
                                        data-original-title="{{ Lang::get('administrable-testimonial::translations.default.delete') }}"><i class="ti-close"></i></a>
                                </nav>
                            </td>
